...
module.exports = async(client, interaction) => {
    if (interaction.isCommand() || interaction.isContextMenu()) {
        ...
        if(!interaction.guild.me.permissions.has(Permissions.FLAGS.MANAGE_MESSAGES)) return interaction.reply(`I don't have the permission to manage messages in ${interaction.guild.name}`);
