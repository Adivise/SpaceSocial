module.exports = async (client, msg, pages, emojiList, timeout, clanLength) => {
    ...
    let page = 0;
    const curPage = await msg.channel.send({ embeds: [pages[page].setFooter({ text: `Page • ${page + 1}/${pages.length} | ${clanLength} • Total Clans`})] });
    ...
    reactionCollector.on('collect', (reaction, user) => {
        ...
        curPage.edit({ embeds: [pages[page].setFooter({ text: `Page • ${page + 1}/${pages.length} | ${clanLength} • Total Clans`})] });
    });
